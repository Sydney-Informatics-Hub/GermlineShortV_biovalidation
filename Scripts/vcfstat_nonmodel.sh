...
# Usage: qsub vcfstat_nonmodel.sh (or bash vcfstat_nonmodel.sh)
# Version: 1.0
#
...
# define variables
vcfdir= #where are your vcfs stored
summariesdir= #where do you want the summaries to be stored
pedigree= #whats the path to and name of your pedigree file
cohort= #whats the prefix of your cohort vcf
...
if [[ -d ${bcftoolsmetrics}_vcfstatsplots && -f ${smplstats} ]]; then
